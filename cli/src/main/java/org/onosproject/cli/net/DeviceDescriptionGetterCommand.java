...
@Command(scope = "onos", name = "device-descs",
        description = "Gets the device description of the specified device.")
public class DeviceDescriptionGetterCommand  extends AbstractShellCommand {
